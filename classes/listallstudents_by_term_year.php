...
//	if(! isset($_SESSION['membertype']) || ($_SESSION['membertype'] != 10 && $_SESSION['membertype'] != 55) ) {
...
if($showTerm !="fall" && $showTerm !="spring"){
	$showTerm= "fall";
}
...
echo "School Year: ".$fallYear." - ".$springYear;
?>
...
$queryLf= "(SELECT a.StudentMemberID as id, b.GradeOrSubject as grade, b.ClassNumber as classnum, b.ClassID as ClassID,b.Classroom as Classroom
           FROM tblClassRegistration a JOIN tblClass b on a.ClassID=b.ClassID
           WHERE b.IsLanguage ='Yes' and b.Year='" .$fallYear."' and b.Term='Fall' and a.Status in ('OK','Taken')) cclassf";
$query0f = "(SELECT a0.StudentMemberID as id, b0.GradeOrSubject as exclass0, b0.ClassID as ClassID,b0.Classroom as Classroom
           FROM tblClassRegistration a0 JOIN tblClass b0 on a0.ClassID=b0.ClassID
           WHERE b0.IsLanguage ='No' and b0.Period=0 and b0.Year='" .$fallYear."' and b0.Term='Fall' and a0.Status in ('OK','Taken')) eclass0f";
$query1f = "(SELECT a1.StudentMemberID as id, b1.GradeOrSubject as exclass1, b1.ClassID as ClassID,b1.Classroom as Classroom
           FROM tblClassRegistration a1 JOIN tblClass b1 on a1.ClassID=b1.ClassID
           WHERE b1.IsLanguage ='No' and b1.Period=1 and b1.Year='" .$fallYear."' and b1.Term='Fall' and a1.Status in ('OK','Taken')) eclass1f";
$query2f = "(SELECT a2.StudentMemberID as id, b2.GradeOrSubject as exclass2, b2.ClassID as ClassID,b2.Classroom as Classroom
           FROM tblClassRegistration a2 JOIN tblClass b2 on a2.ClassID=b2.ClassID
           WHERE b2.IsLanguage ='No' and b2.Period=2 and b2.Year='" .$fallYear."' and b2.Term='Fall' and a2.Status in ('OK','Taken')) eclass2f";
$query3f = "(SELECT a3.StudentMemberID as id, b3.GradeOrSubject as exclass3, b3.ClassID as ClassID,b3.Classroom as Classroom
           FROM tblClassRegistration a3 JOIN tblClass b3 on a3.ClassID=b3.ClassID
           WHERE b3.IsLanguage='No' and b3.Period=3 and b3.Year='" .$fallYear."' and b3.Term='Fall' and a3.Status in ('OK','Taken')) eclass3f";
$query4f = "(SELECT a3.StudentMemberID as id, b3.GradeOrSubject as exclass4, b3.ClassID as ClassID,b3.Classroom as Classroom
           FROM tblClassRegistration a3 JOIN tblClass b3 on a3.ClassID=b3.ClassID
           WHERE b3.IsLanguage='No' and b3.Period=4 and b3.Year='" .$fallYear."' and b3.Term='Fall' and a3.Status in ('OK','Taken')) eclass4f";

$queryLs= "(SELECT a1.StudentMemberID as id, b1.GradeOrSubject as grade, b1.ClassNumber as classnum, b1.ClassID as ClassID,b1.Classroom as Classroom
           FROM tblClassRegistration a1 JOIN tblClass b1 on a1.ClassID=b1.ClassID
           WHERE b1.IsLanguage ='Yes' and b1.Year='" .$springYear."' and b1.Term='Spring' and a1.Status in ('OK','Taken')) cclasss";
$query0s = "(SELECT a1.StudentMemberID as id, b1.GradeOrSubject as exclass0, b1.ClassNumber as classnum, b1.ClassID as ClassID,b1.Classroom as Classroom
           FROM tblClassRegistration a1 JOIN tblClass b1 on a1.ClassID=b1.ClassID
           WHERE b1.IsLanguage ='No' and b1.Period=0 and b1.Year='" .$springYear."' and b1.Term='Spring' and a1.Status in ('OK','Taken')) eclass0s";
$query1s = "(SELECT a2.StudentMemberID as id, b2.GradeOrSubject as exclass1, b2.ClassID as ClassID,b2.Classroom as Classroom
           FROM tblClassRegistration a2 JOIN tblClass b2 on a2.ClassID=b2.ClassID
           WHERE b2.IsLanguage ='No' and b2.Period=1 and b2.Year='" .$springYear."' and b2.Term='Spring' and a2.Status in ('OK','Taken')) eclass1s";
$query2s = "(SELECT a2.StudentMemberID as id, b2.GradeOrSubject as exclass2, b2.ClassID as ClassID,b2.Classroom as Classroom
           FROM tblClassRegistration a2 JOIN tblClass b2 on a2.ClassID=b2.ClassID
           WHERE b2.IsLanguage ='No' and b2.Period=2 and b2.Year='" .$springYear."' and b2.Term='Spring' and a2.Status in ('OK','Taken')) eclass2s";
$query3s = "(SELECT a3.StudentMemberID as id, b3.GradeOrSubject as exclass3, b3.ClassID as ClassID,b3.Classroom as Classroom
           FROM tblClassRegistration a3 JOIN tblClass b3 on a3.ClassID=b3.ClassID
           WHERE b3.IsLanguage ='No' and b3.Period=3 and b3.Year='" .$springYear."' and b3.Term='Spring' and a3.Status in ('OK','Taken')) eclass3s";
$query4s = "(SELECT a3.StudentMemberID as id, b3.GradeOrSubject as exclass4, b3.ClassID as ClassID,b3.Classroom as Classroom
           FROM tblClassRegistration a3 JOIN tblClass b3 on a3.ClassID=b3.ClassID
           WHERE b3.IsLanguage ='No' and b3.Period=4 and b3.Year='" .$springYear."' and b3.Term='Spring' and a3.Status in ('OK','Taken')) eclass4s";
...
//               StudentStatus,
		 ...
		 cclassf.Classroom as classroomf,
		 eclass0f.Classroom as ex0classroomf,
		 eclass1f.Classroom as ex1classroomf,
		 eclass2f.Classroom as ex2classroomf,
		 eclass3f.Classroom as ex3classroomf,
		 eclass4f.Classroom as ex4classroomf,
		 ...
		 cclasss.Classroom as classrooms,
		 eclass0s.Classroom as ex0classrooms,
		 eclass1s.Classroom as ex1classrooms,
		 eclass2s.Classroom as ex2classrooms,
		 eclass3s.Classroom as ex3classrooms,
		 eclass4s.Classroom as ex4classrooms,
                 Registered".
...
<?php if ($showTerm == "fall" ) { ?>
					<td><?php if ( $row[gradef] !="" ) {echo "[".$row[classidf]."] "."[".$row[classroomf]."] ".$row[gradef]. "-" .$row[classnumf];} ?>&nbsp;</td>
					<td><?php if ( $row[ex0classidf] !="" ) {echo "[".$row[ex0classidf]."] "."[".$row[ex0classroomf]."] ".$row[exclass0f];} ?>&nbsp;</td>
					<td><?php if ( $row[ex1classidf] !="" ) {echo "[".$row[ex1classidf]."] "."[".$row[ex1classroomf]."] ".$row[exclass1f];} ?>&nbsp;</td>
					<td><?php if ( $row[ex2classidf] !="" ) {echo "[".$row[ex2classidf]."] "."[".$row[ex2classroomf]."] ".$row[exclass2f];} ?>&nbsp;</td>
					<td><?php if ( $row[ex3classidf] !="" ) {echo "[".$row[ex3classidf]."] "."[".$row[ex3classroomf]."] ".$row[exclass3f];} ?>&nbsp;</td>
					<td><?php if ( $row[ex4classidf] !="" ) {echo "[".$row[ex4classidf]."] "."[".$row[ex4classroomf]."] ".$row[exclass4f];} ?>&nbsp;</td>
<?php }
      if ($showTerm == "spring" ) { ?>

					<td><?php if ( $row[classids] !="" ) {echo "[".$row[classids]."] "."[".$row[classrooms]."] ".$row[grades]. "-" .$row[classnums];} ?>&nbsp;</td>
					<td><?php if ( $row[ex0classids] !="" ) {echo "[".$row[ex0classids]."] "."[".$row[ex0classrooms]."] ".$row[exclass0s];} ?>&nbsp;</td>
					<td><?php if ( $row[ex1classids] !="" ) {echo "[".$row[ex1classids]."] "."[".$row[ex1classrooms]."] ".$row[exclass1s];} ?>&nbsp;</td>
					<td><?php if ( $row[ex2classids] !="" ) {echo "[".$row[ex2classids]."] "."[".$row[ex2classrooms]."] ".$row[exclass2s];} ?>&nbsp;</td>
					<td><?php if ( $row[ex3classids] !="" ) {echo "[".$row[ex3classids]."] "."[".$row[ex3classrooms]."] ".$row[exclass3s];} ?>&nbsp;</td>
					<td><?php if ( $row[ex4classids] !="" ) {echo "[".$row[ex4classids]."] "."[".$row[ex4classrooms]."] ".$row[exclass4s];} ?>&nbsp;</td>
