			...
			<table height="360" width="100%" border="0" bgcolor="white">
				<tr>
					...
					<?php
 					...
 					$SQLstring = $SQLstring = "select tblTeachingMaterials.*, LastName, FirstName from tblTeachingMaterials INNER JOIN tblMember ON MemberID=CreatedByMemberID where DisplayOnline='Y' ORDER BY MaterialGrade ASC, LastName ASC";
