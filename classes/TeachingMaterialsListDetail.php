			...
			<table height="360" width="100%" border="0" bgcolor="white">
				<tr>
					...
					<?php
 					...
 					$SQLstring = $SQLstring = "select tblTeachingMaterials.*, LastName, FirstName from tblTeachingMaterials INNER JOIN tblMember ON MemberID=CreatedByMemberID where DisplayOnline='Y' ORDER BY MaterialType ASC, FileDescription ASC";
					$RS1=mysqli_query($conn,$SQLstring);
					
					?>

					<td align="center" valign="top">
						<br>Teaching Material List</font>
					  ...
					  while ( $row=mysqli_fetch_array($RS1) ){
						echo "	<tr>";
						echo "	</td><td align=center>". $row[FileDescription] ."</td><td align=center>". $row[MaterialType] . "</td><td nowrap align=center>". $row[MaterialGrade] ."</td>" ;
